package com.baoxina.statemachine.comtroller;
...
public class OrderController {
    ...
    public ResponseEntity processOrderState(@PathVariable("orderId") Integer orderId, @RequestParam("event") OrderEvents event) {
